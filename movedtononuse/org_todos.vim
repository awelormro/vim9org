...
#  }}}
# Command creation {{{
command -buffer OrgTODOToggleRight OrgTodoShifterRight()
command -buffer OrgTODOToggleLeft OrgTodoShifterLeft()
command -buffer OrgTODOTogglePriorUp OrgPrioritiesRight()
command -buffer OrgTODOTogglePriorDwn OrgPrioritiesLeft()
